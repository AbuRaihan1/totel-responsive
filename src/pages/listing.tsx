...
import SideNavigation from "@/components/listing/SideNavigation";
    ...
    <div>
      ...
      <RootLayout>
        <div className="bg-white pt-3 flex flex-row items-start justify-start text-[0.94rem] text-gray-50  lg:h-auto  md:flex-row sm:flex-col">
          <div className="border-4 self-stretch bg-white box-border w-[17.5rem] overflow-hidden shrink-0 flex flex-col py-[0.75rem] px-[0rem] items-start justify-start gap-[0.25rem] border-r-[1px] border-solid border-card  lg:h-auto md:flex-col sm:flex-col">
            <Link href="/inbox">
