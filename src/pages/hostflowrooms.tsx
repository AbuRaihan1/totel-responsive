  ...
  return (
    <div>
      ...
      <div className="mt-5 mx-3 space-y-4">
        <div className="font-semibold text-sm leading-7 tracking-[-0.1px]">
          Step-1
        </div>
        ...
        <div className="box-border h-[422px] border rounded-3xl border-solid border-[#DAE0E6] bg-[url(/Images/page1.jpg)] object-fit bg-cover bg-no-repeat"></div>
      </div>
